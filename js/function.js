$(function(){
    ...
    $('#staff-13').click(function(){
        ...
        $(this).slideUp("slow");
        last_slideUp = $(this);
        $("#staff-13-card").slideDown("slow");
    });
    $('#staff-14').click(function(){
        $(".staff-card").slideUp("slow");
        if(last_slideUp != null){
            last_slideUp.slideDown("slow");
        }
        $(this).slideUp("slow");
        last_slideUp = $(this);
        $("#staff-14-card").slideDown("slow");
    });
    $('#staff-15').click(function(){
        $(".staff-card").slideUp("slow");
        if(last_slideUp != null){
            last_slideUp.slideDown("slow");
        }
